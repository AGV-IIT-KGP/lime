...
// To store the path to config file where parameters for filters and icp are
// declared
...
int main(int argc, char **argv) {
  ...
  pcl::io::loadPCDFile<pcl::PointXYZ>(
	  string(argv[1]),
    //   "/media/shreyanshdarshan/New Volume/vision/PCL/XYZ2PCD/build/pepsi_down.pcd",
      *map_cloud);
  ros::Subscriber sub =
  ...
  ros::Publisher grid_pub =
      n.advertise<sensor_msgs::PointCloud2>("/grid_map", 1000);
